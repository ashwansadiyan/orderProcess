$(document).ready(function () {
    ...
    $("#btnPrPd").removeClass("btn-warning").addClass("btn-primary");
...
function bindOrderProcceingDetails() {
    ...
    $.ajax({
        ...
        url: "http://localhost:32314/Api/Orders/GetCustomerOrderBystatus?Id=3",
        aync: false,
        success: function (t) {
            if (t.length > 0) {
                orderObject = t;
    ...
    for (var i = 0; i < orderObject.length; i++) {
        ...
        var tableBodyClose = "<tr style='background-color:#337ab7' class='text-light' >" +
            ...
            "<button type='button' onclick='updateOrder(this," + orderID + ");' style='width:100%;height:35px;' class='btn btn-primary'>Picked-Up</button>" +
